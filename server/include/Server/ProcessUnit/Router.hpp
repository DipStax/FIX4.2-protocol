...
namespace pu
{
    ...
    {
        public:
            Router(UnparsedMessageQueue &_logon, UnparsedMessageQueue &_logout, UnparsedMessageQueue &_heartbeat, UnparsedMessageQueue &_market_router, UnparsedMessageQueue &_md_router, StringOutputQueue &_error);
        ...
        private:
            ...
            UnparsedMessageQueue &m_marketdata_router;
