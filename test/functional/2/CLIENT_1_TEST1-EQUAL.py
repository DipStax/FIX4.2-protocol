...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=124{chr(1)}35=D{chr(1)}49=CLIENT_1{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240124-00:21:54.265{chr(1)}11=1{chr(1)}21=3{chr(1)}38=100{chr(1)}40=2{chr(1)}44=1000{chr(1)}54=4{chr(1)}55=GOLD{chr(1)}60=20210201-10:00:000{chr(1)}10=104{chr(1)}"
LOGOUT_MSG = f"8=FIX.4.2{chr(1)}9=59{chr(1)}35=5{chr(1)}49=CLIENT_1{chr(1)}56=MyMarket{chr(1)}34=4{chr(1)}52=20240124-00:21:54.265{chr(1)}10=081{chr(1)}"
...
try:
    ...
    assert response["34"] == "4", f"Logout message failed. Expected MsgSeqNum(34) = 4. Instead received: {response['34']}"
