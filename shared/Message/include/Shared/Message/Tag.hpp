...
namespace fix
{
    ...
    /// @return If the first element is true then second is set, otherwise it rigly formated.
    template<>
    UNUSED std::pair<bool, Reject> verify<Tag::SenderCompId>(const std::string &_value, const std::string &_sender);
    ...
    /// @return If the first element is true then second is set, otherwise it rigly formated.
    template<>
    UNUSED std::pair<bool, Reject> verify<Tag::TargetCompId>(const std::string &_value, const std::string &_target);
...
#include "Shared/Message/Tag.inl"