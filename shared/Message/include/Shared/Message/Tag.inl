...
namespace fix
{
    ...
    template<>
    std::pair<bool, Reject> verify<Tag::SenderCompId>(const std::string &_value, const std::string &_sender)
    {
        std::pair<bool, fix::Reject> reject = { false, {} };
    ...
    template<>
    std::pair<bool, Reject> verify<Tag::TargetCompId>(const std::string &_value, const std::string &_target)
    {
        std::pair<bool, fix::Reject> reject = { false, {} };
